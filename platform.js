...
const isTablet = /(ipad|tablet|(macintosh *) |(android(?!.*mobile))|(windows(?!.*phone)(.*touch))|kindle|playbook|silk|(puffin(?!.*(IP|AP|WP))))/.test(userAgent);
...
function getYouCode() {
  document.getElementById('isMobile').innerHTML = "DeviceType:" + DeviceType();
  document.getElementById('osName').innerHTML = getOSInfo();
  document.getElementById('browserInfo').innerHTML = getBrowserName();
}
...
function checkTabletOrMobileOrDesktopFromWindowScreenSize() {
  ...
  document.getElementById("userAgent").innerHTML = "width " + viewportWidth + "height " + innerHeight
